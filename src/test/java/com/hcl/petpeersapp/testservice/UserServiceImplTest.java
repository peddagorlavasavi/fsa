...
import com.hcl.petpeersapp.converter.UserConverter;
...
import com.hcl.petpeersapp.service.UserServiceImpl;
...
public class UserServiceImplTest {
	...
	private static final com.hcl.petpeersapp.domain.User alex = null;
	...
	@Autowired
	IConverter<com.hcl.petpeersapp.domain.User, User> userconverter = new UserConverter();
	...
	public void whenValidId_thenUserShouldBeUpdated() {
		...
		com.hcl.petpeersapp.domain.User user = userService.createUser(userconverter.convert(alex));
